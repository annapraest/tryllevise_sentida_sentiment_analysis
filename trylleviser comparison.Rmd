...
## SENTIDA analysis of trylleviser 
...
#replacing various line break representations with a single space, remvoing leading and trailing spaces, replacing multiple spaces with a single space
...
kable(trylleviser[, c("songtitle", "lyrics_shortened", "lyrics_clean_shortened")], format = "html", escape = FALSE) %>%
...
```{r sentiment analysis result trylleviser, echo=TRUE, eval=TRUE, include=TRUE}
kable(trylleviser[, c("songtitle", "sentiment_scores")], format = "html") %>%
  kable_styling(full_width = FALSE)
```
...
#Replacing various line break representations with a single space, remvoing leading and trailing spaces, replacing multiple spaces with a single space, seperating songs into tokens (words) using unnest_tokens function
...
kable(head(trylleviser_token[, c("songtitle", "lyrics_shortened", "word")]), format = "html") %>%
  kable_styling(full_width = FALSE)
```
...
```{r sentiment analysis result with tokenized words trylleviser, echo=TRUE, eval=TRUE, include=TRUE}
kable(trylleviser_token_grouped[, c("songtitle", "sentiment_scores")], format = "html") %>%
  kable_styling(full_width = FALSE)
```
...
kable(trylleviser_token_number_of_words)
```
...
#using kable function to show the count
kable(trylleviser_token_number_of_words_no_stopwords)
```

## Combining results on sentiment analysis done om trylleviser
